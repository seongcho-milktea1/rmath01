...
```{r point-to-line2, echo = FALSE, out.width = '70%', fig.cap = '무수히 많은 점으로 이루어진 선'}
knitr::include_graphics("images/0501_point-to-line2.gif")
```
...
library(magick)
for (i in 1:3) {
  filename1 <- paste0("images/line-to-polygon",i,'.gif')
  filename1a <- paste0("images/line-to-polygon",i,'a.gif')
  poly1 <- image_read(filename1)
  poly1a <- image_crop(poly1, "390x480+50+0")
  image_write(poly1a, filename1a)
}
```

```{r line-to-poly3, echo = FALSE, fig.show = "hold", out.width = "33%", fig.align = "default", fig.cap = '무수히 많은 선으로 이루어진 면 (세가지 경우)'}
knitr::include_graphics("images/0502_line-to-polygon1a.gif")
knitr::include_graphics("images/0502_line-to-polygon2a.gif")
knitr::include_graphics("images/0502_line-to-polygon3a.gif")
```
...
```{r point-line-intersection, echo = FALSE, out.width = '70%', fig.cap = '점과 선이 만나서 생기는 교점'}
knitr::include_graphics("images/0503_point-line-intersection.png")
```
...
```{r line-line-intersection, echo = FALSE, out.width = '70%', fig.cap = '선과 선이 만나서 생기는 교점과 교선'}
knitr::include_graphics("images/0504_line-line-intersection.png")
```
...
```{r line-polygon-intersection, echo = FALSE, out.width = '70%', fig.cap = '선과 면이 만나서 생기는 교점과 교선'}
knitr::include_graphics("images/0505_line-polygon-intersection.png")
```
...
```{r polygon-polygon-intersection, echo = FALSE, out.width = '70%', fig.cap = '면과 면이 만나서 생기는 교점과 교선, 그리고 교면'}
knitr::include_graphics("images/0506_polygon-polygon-intersection.png")
```
...
```{r line-segment, echo = FALSE, out.width = '100%', fig.cap = '직선 $l$, 반직선 $m$과 $n$, 그리고 선분 $o$'}
knitr::include_graphics("images/0507_line-segment2.png")
```
...
```{r mid-point, echo = FALSE, out.width = '40%', fig.cap = '선분 $AB$의 중점 $M$'}
knitr::include_graphics("images/0508_mid-point.png")
```
...
```{r line-segment-angle, echo = FALSE, out.width = '30%', fig.cap = '각 $AOB$ $M$'}
knitr::include_graphics("images/0509_line-segment-angle.png")
```
...
```{r straight-angle, echo = FALSE, out.width = '25%', fig.cap = '평각'}
knitr::include_graphics("images/0510_straight-angle.png")
```
...
```{r acute-obtuse-angle, echo = FALSE, out.width = '50%', fig.cap = '예각과 둔각'}
knitr::include_graphics("images/0511_acute-obtuse-angle.png")
```
...
```{r vertical-angle, echo = FALSE, out.width = '40%', fig.cap = '맞꼭지각'}
knitr::include_graphics("images/0512_vertical-angle.png")
```
...
```{r line-orthogonality, echo = FALSE, out.width = '30%', fig.cap = '두 직선의 직교 관계'}
knitr::include_graphics("images/0513_line-orthogonality.png")
```
...
```{r perpendicular-bisector, echo = FALSE, out.width = '30%', fig.cap = '선분 AB의 수직이등분선 $l$'}
knitr::include_graphics("images/0514_perpendicular-bisector.png")
```
...
```{r perpendicular-distance, echo = FALSE, out.width = '30%', fig.cap = '수선의 발과 점 P와 직선 $l$사이의 거리'}
knitr::include_graphics("images/0515_perpendicular-distance.png")
```
...
```{r point-line-relation, echo = FALSE, out.width = '70%', fig.cap = '점과 직선의 위치 관계'}
knitr::include_graphics("images/0516_point-line-relation.png")
```
...
```{r line-line-relation, echo = FALSE, out.width = '100%', fig.cap = '두 직선의 위치 관계'}
knitr::include_graphics("images/0517_line-line-relation.png")
```
...
```{r skew-lines, echo = FALSE, out.width = '40%', fig.cap = '꼬인 위치에 있는 두 직선'}
knitr::include_graphics("images/0518_skew-lines.png")
```
...
```{r line-plane-parallel, echo = FALSE, out.width = '35%', fig.cap = '평면과 평행한 직선'}
knitr::include_graphics("images/0519_line-plane-parallel.png")
```
...
```{r corresponding-angles, echo = FALSE, out.width = '40%', fig.cap = '동위각과 엇각'}
knitr::include_graphics("images/0520_corresponding-angles.png")
```
...
```{r parallel-angles, echo = FALSE, out.width = '40%', fig.cap = '평행선과 동위각, 평행선과 엇각'}
knitr::include_graphics("images/0521_parallel-angles.png")
```
...
```{r construction-line-CD, echo = FALSE, out.width = '50%', fig.cap = '선분 AB와 길이가 같은 선분 CD'}
knitr::include_graphics("images/0522_construction-line-CD.png")
```
...
```{r construction-line-ABtimes2, echo = FALSE, out.width = '50%', fig.cap = '길이가 선분 AB 길이의 2배인 선분 BC'}
knitr::include_graphics("images/0523_construction-line-ABtimes2.png")
```
...
```{r construction-line-EF, echo = FALSE, out.width = '50%', fig.cap = '길이가 선분 AB + 선분 CD인 선분 EF'}
knitr::include_graphics("images/0524_construction-line-EF.png")
```
...
```{r construction-same-angle, echo = FALSE, out.width = '50%', fig.cap = '각 O와 크기가 같은 각 A'}
knitr::include_graphics("images/0525_construction-same-angle.png")
```
...
```{r construction-parallel, echo = FALSE, out.width = '50%', fig.cap = '점 P를 지나고 직선 l과 평행한 직선'}
knitr::include_graphics("images/0526_construction-parallel.png")
```
...
```{r triangle-angle-side, echo = FALSE, out.width = '30%', fig.cap = '각 A의 대변 BC, 변 BC의 대각 A'}
knitr::include_graphics("images/0527_triangle-angle-side.png")
```
...
```{r triangle-three-sides, echo = FALSE, out.width = '50%', fig.cap = '세 변의 길이가 주어질 때'}
knitr::include_graphics("images/0528_triangle-three-sides.png")
```
...
```{r triangle-two-sides, echo = FALSE, out.width = '50%', fig.cap = '두 변의 길이와 그 끼인각의 크기가 주어질 때'}
knitr::include_graphics("images/0529_triangle-two-sides.png")
```
...
```{r triangle-one-side, echo = FALSE, out.width = '50%', fig.cap = '한 변의 길이와 그 양 끝 각의 크기가 주어질 때'}
knitr::include_graphics("images/0530_triangle-one-side.png")
```
...
```{r triangle-congruence, echo = FALSE, out.width = '50%', fig.cap = '서로 합동인 삼각형 ABC$와 삼각형 DEF'}
knitr::include_graphics("images/0531_triangle-congruence.png")
```
