...
```{r golden-ratio-line-rectangle, echo = FALSE, out.width = '50%', fig.cap = '두 선의 두 직사각형의 황금비율 관계 <font size="2">(출처 <https://en.wikipedia.org/wiki/Golden_ratio>)</font>'}
knitr::include_graphics("images/0301_golden-ratio-line-rectangle.png")
```
...
```{r golden-ratio-3, echo = FALSE, out.width = '100%', fig.cap = '건축물, 미술품, 사진 작품에서 찾아볼 수 있는 황금비율 <font size="2">(출처 <https://www.geogebra.org/m/nmuaSXrK>)</font>'}
knitr::include_graphics("images/0302_golden-ratio-3.png")
```
...
```{r FibonacciRabbit, echo = FALSE, out.width = '70%', fig.cap = '토끼 개체 수를 이용한 피보나치 수의 설명 <font size="2">(출처 <https://en.wikipedia.org/wiki/Fibonacci_number>)</font>'}
knitr::include_graphics("images/0303_FibonacciRabbit.png")
```
...
```{r Fibonacci-numbers-graph, echo = FALSE, out.width = '70%', fig.cap = '피보나치 수의 증가 패턴'}
knitr::include_graphics("images/0304_Fibonacci-numbers-graph.png")
```
...
```{r Fibonacci-golden-ratio-graph, echo = FALSE, out.width = '70%', fig.cap = '각 피보나치 수의 증가 비율'}
knitr::include_graphics("images/0305_Fibonacci-golden-ratio-graph.png")
```
...
```{r golden-ratio-rect1, echo = FALSE, out.width = '70%', fig.cap = '피보나치 사각형'}
knitr::include_graphics("images/0306_golden-ratio-rect1.png")
```
...
```{r golden-ratio-rect2, echo = FALSE, out.width = '70%', fig.cap = '피보나치 사각형 (나선형 배치)'}
knitr::include_graphics("images/0307_golden-ratio-rect2.png")
```
...
```{r rootSolve, echo = FALSE, out.width = '50%', fig.cap = 'rootSolve 패키지를 이용한 일차방정식의 해'}
knitr::include_graphics("images/0308_rootSolve.png")
```
